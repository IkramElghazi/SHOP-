...
<html lang="en" dir="ltr">
  <head>
    ...
    <script src="https://kit.fontawesome.com/74e9b61e45.js" crossorigin="anonymous"></script>
...
<section class="overflow-hidden flex justify-center items-center rounded-lg shadow-2xl md:grid md:grid-cols-3">
  <img
    alt="Trainer"
  ...
  <div class="p-4 text-center mt-12 sm:p-6 md:col-span-2 lg:p-8">
...
<section>
  <div class="max-w-screen-xl px-500  py-8 sm:px-10 sm:py-20 lg:px-8">
    <header class="text-center">
      <h2 class="text-xl font-bold text-red-900 sm:text-3xl">
        New Collection
      </h2>
    </header>

    <ul class="grid grid-cols-1 gap-4 mt-5 lg:grid-cols-3">
      <li class="mt-12">
        <a href="#" class="relative block group">
          ...
          <div
            class="absolute inset-0  flex flex-col mt-5 items-start justify-end p-6"
          >
            <h3 class="text-xl font-medium text-white">Casual Trainers</h3>

            <span
              class="mt-5 inline-block bg-black px-5 py-3 text-xs font-medium uppercase tracking-wide text-white"
            >
              Shop Now
            </span>
          </div>
      ...
      <li class="lg:col-span-2 lg:col-start-2 mt-12 lg:row-span-2 lg:row-start-1">
        <a href="#" class="relative block group">
          <img
    ...
    <ul class="grid gap-4 mt-8 sm:grid-cols-2 lg:grid-cols-4">
      <li>
        <a href="#" class="block overflow-hidden group">
          <img
          src="https://cdn.laredoute.com/products/f/b/c/fbca1cbf8604772c772db9866cade949.jpg?width=400&dpr=1"
            alt=""
          ...
          <div class="relative pt-3 bg-white">
            ...
            <p class="mt-2">
              ...
              <span class="tracking-wider text-gray-900"> 24O.00 MAD </span>
              <a
...
>
  Acheté
      ...
      <li>
        <a href="art1.php" class="block overflow-hidden group">
          <img 
          ...
          <div class="relative pt-3 bg-white">
            ...
            <p class="mt-2">
              ...
              <span class="tracking-wider text-gray-900"> 190.00 MAD </span>
              <a
  class="inline-block rounded border border-indigo-600 px-12 py-3 text-sm font-medium text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
  href="art1.php"
>
  Acheté
      ...
      <li>
        <a href="#" class="block overflow-hidden group">
          <img
src="https://ma.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/86/502015/1.jpg?9327"
          alt=""
            class="h-[350px] w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[450px]"
          />
          ...
          <div class="relative pt-3 bg-white">
            ...
            <p class="mt-2">
              ...
              <span class="tracking-wider text-gray-900"> 332.00 MAD </span>
              <a
  class="inline-block rounded border border-indigo-600 px-12 py-3 text-sm font-medium text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
  href="art1.php"
>
...
src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXX9zzTKr6t146CDkm2yHLRqIC1Y7DXDgUJA&usqp=CAU"
          ...
          <div class="relative pt-3 bg-white">
            ...
            <p class="mt-2">
              ...
              <span class="tracking-wider text-gray-900"> 284.00 MAD </span>
              <a
  class="inline-block rounded border border-indigo-600 px-12 py-3 text-sm font-medium text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
  href="art1.php"
>
